...
> 현재 상태 기준 주의: 이 문서는 2026-05-07 당시 작업 기록입니다.
> 2026-06-01 현재 코드와 서비스 흐름은 `VELORA_HANDOFF_20260601.md`를 우선 기준으로 확인하세요.
> 특히 모델 구조, 실행 API, 계정/이력 흐름, 데모 fallback 관련 내용은 이후 작업에서 변경되었습니다.
